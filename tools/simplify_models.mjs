...
for (const [id, spec] of Object.entries(targets)) {
  ...
  await doc.transform(dedup(), weld({}), simplify({ simplifier: MeshoptSimplifier, ratio, error, lockBorder: false }), prune());
