...
export const PRESETS = {
  low: {
    resScale: 0.6, minScale: 0.45, dynamicRes: true, dprCap: 1, msaa: 0, shadows: 1, shadowSize: 512,
    bloom: true, bloomLevels: 4, motionBlur: false, mbSamples: 4, mbStrength: 0.8, lightPool: 3,
    rain: 0.4, maxCorpses: 6, bodyDetail: 0, lowTex: true, sharpen: 0.25, targetFps: 45,
  },
  medium: {
    ...
    rain: 0.7, maxCorpses: 10, bodyDetail: 1, lowTex: false, sharpen: 0.3, targetFps: 55,
  },
  high: {
    ...
    rain: 1.0, maxCorpses: 16, bodyDetail: 2, lowTex: false, sharpen: 0.35, targetFps: 58,
  },
  ultra: {
    ...
    rain: 1.2, maxCorpses: 24, bodyDetail: 2, lowTex: false, sharpen: 0.35, targetFps: 58,
  },
};
...
export function detectQuality() {
  ...
  if (/intel|iris|uhd|hd graphics/.test(g)) return { quality: 'medium', gpu };
